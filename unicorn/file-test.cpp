...
namespace {
    ...
    void check_file_path_operations() {
        ...
        TRY(p32 = split_file(U".hello"s));     TEST_EQUAL(p32.first, U".hello");  TEST_EQUAL(p32.second, U"");
            ...
            TRY(p8 = split_path("abc/def/hello.txt"s, true));        TEST_EQUAL(p8.first, "abc/def/");     TEST_EQUAL(p8.second, "hello.txt");
            ...
            TRY(p8 = split_path("abc/def/hello"s, true));            TEST_EQUAL(p8.first, "abc/def/");     TEST_EQUAL(p8.second, "hello");
            ...
            TRY(p8 = split_path("abc/def/hello.world.txt"s, true));  TEST_EQUAL(p8.first, "abc/def/");     TEST_EQUAL(p8.second, "hello.world.txt");
            ...
            TRY(p16 = split_path(u"/hello.txt"s));                     TEST_EQUAL(p16.first, u"/");            TEST_EQUAL(p16.second, u"hello.txt");
            TRY(p16 = split_path(u"/hello.txt"s, true));               TEST_EQUAL(p16.first, u"/");            TEST_EQUAL(p16.second, u"hello.txt");
            TRY(p16 = split_file(u"/hello.txt"s));                     TEST_EQUAL(p16.first, u"hello");        TEST_EQUAL(p16.second, u".txt");
            TRY(p16 = split_path(u"abc/def/hello.txt"s));              TEST_EQUAL(p16.first, u"abc/def");      TEST_EQUAL(p16.second, u"hello.txt");
            TRY(p16 = split_path(u"abc/def/hello.txt"s, true));        TEST_EQUAL(p16.first, u"abc/def/");     TEST_EQUAL(p16.second, u"hello.txt");
            ...
            TRY(p16 = split_path(u"abc/def/hello"s, true));            TEST_EQUAL(p16.first, u"abc/def/");     TEST_EQUAL(p16.second, u"hello");
            ...
            TRY(p16 = split_path(u"abc/def/hello.world.txt"s, true));  TEST_EQUAL(p16.first, u"abc/def/");     TEST_EQUAL(p16.second, u"hello.world.txt");
            ...
            TRY(p32 = split_path(U"/hello.txt"s));                     TEST_EQUAL(p32.first, U"/");            TEST_EQUAL(p32.second, U"hello.txt");
            TRY(p32 = split_path(U"/hello.txt"s, true));               TEST_EQUAL(p32.first, U"/");            TEST_EQUAL(p32.second, U"hello.txt");
            TRY(p32 = split_file(U"/hello.txt"s));                     TEST_EQUAL(p32.first, U"hello");        TEST_EQUAL(p32.second, U".txt");
            TRY(p32 = split_path(U"abc/def/hello.txt"s));              TEST_EQUAL(p32.first, U"abc/def");      TEST_EQUAL(p32.second, U"hello.txt");
            TRY(p32 = split_path(U"abc/def/hello.txt"s, true));        TEST_EQUAL(p32.first, U"abc/def/");     TEST_EQUAL(p32.second, U"hello.txt");
            ...
            TRY(p32 = split_path(U"abc/def/hello"s, true));            TEST_EQUAL(p32.first, U"abc/def/");     TEST_EQUAL(p32.second, U"hello");
            ...
            TRY(p32 = split_path(U"abc/def/hello.world.txt"s, true));  TEST_EQUAL(p32.first, U"abc/def/");     TEST_EQUAL(p32.second, U"hello.world.txt");
            ...
            TRY(p8 = split_path("C:\\hello.txt"s, true));              TEST_EQUAL(p8.first, "C:\\");         TEST_EQUAL(p8.second, "hello.txt");
            ...
            TRY(p16 = split_path(u"C:\\hello.txt"s, true));              TEST_EQUAL(p16.first, u"C:\\");         TEST_EQUAL(p16.second, u"hello.txt");
            ...
            TRY(p32 = split_path(U"C:\\hello.txt"s, true));              TEST_EQUAL(p32.first, U"C:\\");         TEST_EQUAL(p32.second, U"hello.txt");
