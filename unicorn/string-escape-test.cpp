...
void test_unicorn_string_escape_backslash() {
    ...
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_escape(s1, Escape::ascii));   TEST_EQUAL(s2, u8"(\"\\x01\\u0080\\u00a7\\u00b6 \\\\ \\u20acuro \\U00012000\\n\")");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_escape(s1, Escape::nostdc));  TEST_EQUAL(s2, u8"(\"\\x01\u0080§¶ \\\\ €uro \U00012000\\x0a\")");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_escape(s1, Escape::pcre));    TEST_EQUAL(s2, u8"(\"\\x01\\x{80}\\x{a7}\\x{b6} \\\\ \\x{20ac}uro \\x{12000}\\n\")");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_escape(s1, Escape::punct));   TEST_EQUAL(s2, u8"\\(\\\"\\x01\u0080§¶ \\\\ €uro \U00012000\\n\\\"\\)");
    ...
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_escape_in(s1, Escape::ascii));   TEST_EQUAL(s1, u8"(\"\\x01\\u0080\\u00a7\\u00b6 \\\\ \\u20acuro \\U00012000\\n\")");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_escape_in(s1, Escape::nostdc));  TEST_EQUAL(s1, u8"(\"\\x01\u0080§¶ \\\\ €uro \U00012000\\x0a\")");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_escape_in(s1, Escape::pcre));    TEST_EQUAL(s1, u8"(\"\\x01\\x{80}\\x{a7}\\x{b6} \\\\ \\x{20ac}uro \\x{12000}\\n\")");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_escape_in(s1, Escape::punct));   TEST_EQUAL(s1, u8"\\(\\\"\\x01\u0080§¶ \\\\ €uro \U00012000\\n\\\"\\)");
...
void test_unicorn_string_escape_quote() {
    ...
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_quote(s1, Escape::ascii));   TEST_EQUAL(s2, u8"\"(\\\"\\x01\\u0080\\u00a7\\u00b6 \\\\ \\u20acuro \\U00012000\\n\\\")\"");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_quote(s1, Escape::nostdc));  TEST_EQUAL(s2, u8"\"(\\\"\\x01\u0080§¶ \\\\ €uro \U00012000\\x0a\\\")\"");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_quote(s1, Escape::pcre));    TEST_EQUAL(s2, u8"\"(\\\"\\x01\\x{80}\\x{a7}\\x{b6} \\\\ \\x{20ac}uro \\x{12000}\\n\\\")\"");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(s2 = str_quote(s1, Escape::punct));   TEST_EQUAL(s2, u8"\"\\(\\\"\\x01\u0080§¶ \\\\ €uro \U00012000\\n\\\"\\)\"");
    ...
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_quote_in(s1, Escape::ascii));   TEST_EQUAL(s1, u8"\"(\\\"\\x01\\u0080\\u00a7\\u00b6 \\\\ \\u20acuro \\U00012000\\n\\\")\"");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_quote_in(s1, Escape::nostdc));  TEST_EQUAL(s1, u8"\"(\\\"\\x01\u0080§¶ \\\\ €uro \U00012000\\x0a\\\")\"");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_quote_in(s1, Escape::pcre));    TEST_EQUAL(s1, u8"\"(\\\"\\x01\\x{80}\\x{a7}\\x{b6} \\\\ \\x{20ac}uro \\x{12000}\\n\\\")\"");
    s1 = u8"(\"\u0001\u0080§¶ \\ €uro \U00012000\n\")";  TRY(str_quote_in(s1, Escape::punct));   TEST_EQUAL(s1, u8"\"\\(\\\"\\x01\u0080§¶ \\\\ €uro \U00012000\\n\\\"\\)\"");
