...
* `template <typename C> basic_string<C> str_fold_whitespace(const basic_string<C>& str, Flagset flags = {})`
* `template <typename C> void str_fold_whitespace_in(basic_string<C>& str, Flagset flags = {})`
