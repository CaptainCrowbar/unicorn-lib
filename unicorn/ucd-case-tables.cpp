...
const TableView<char32_t, char32_t> other_lowercase_table {CROW_BOUNDS(other_lowercase_array)};
...
const TableView<char32_t, char32_t> other_uppercase_table {CROW_BOUNDS(other_uppercase_array)};
...
const TableView<char32_t, char32_t> simple_uppercase_table {CROW_BOUNDS(simple_uppercase_array)};
...
const TableView<char32_t, char32_t> simple_lowercase_table {CROW_BOUNDS(simple_lowercase_array)};
...
const TableView<char32_t, char32_t> simple_titlecase_table {CROW_BOUNDS(simple_titlecase_array)};
...
const TableView<char32_t, char32_t> simple_casefold_table {CROW_BOUNDS(simple_casefold_array)};
...
const TableView<char32_t, std::array<char32_t, 3>> full_uppercase_table {CROW_BOUNDS(full_uppercase_array)};

const KeyValue<char32_t, std::array<char32_t, 3>> full_lowercase_array[] {
{0x130,{{0x69,0x307,0x0}}},
};

const TableView<char32_t, std::array<char32_t, 3>> full_lowercase_table {CROW_BOUNDS(full_lowercase_array)};
...
const TableView<char32_t, std::array<char32_t, 3>> full_titlecase_table {CROW_BOUNDS(full_titlecase_array)};
...
const TableView<char32_t, std::array<char32_t, 3>> full_casefold_table {CROW_BOUNDS(full_casefold_array)};
