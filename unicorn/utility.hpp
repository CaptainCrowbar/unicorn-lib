...
namespace RS {
    ...
    Ustring format_date(std::chrono::system_clock::time_point tp, Uview format, uint32_t flags = utc_zone);
    Ustring format_date(std::chrono::system_clock::time_point tp, int prec = 0, uint32_t flags = utc_zone);
    std::chrono::system_clock::time_point make_date(int year, int month, int day, int hour = 0, int min = 0, double sec = 0, uint32_t flags = utc_zone);
