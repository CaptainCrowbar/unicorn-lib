...
build/$(TARGET)/environment.o: unicorn/environment.cpp unicorn/environment.hpp \
  ...
  unicorn/string-property.hpp unicorn/string-size.hpp unicorn/segment.hpp \
...
build/$(TARGET)/file.o: unicorn/file.cpp unicorn/file.hpp unicorn/core.hpp \
  ...
  unicorn/string-algorithm.hpp unicorn/string-forward.hpp unicorn/utf.hpp \
  unicorn/string-property.hpp unicorn/string-size.hpp unicorn/segment.hpp \
  unicorn/string-case.hpp unicorn/string-compare.hpp \
  unicorn/string-conversion.hpp unicorn/string-escape.hpp \
...
build/$(TARGET)/string-case-test.o: unicorn/string-case-test.cpp unicorn/string-case.hpp \
  ...
  unicorn/string-forward.hpp unicorn/string-property.hpp \
  unicorn/string-size.hpp $(LIBROOT)/prion-lib/prion/unit-test.hpp
build/$(TARGET)/string-compare-test.o: unicorn/string-compare-test.cpp \
  unicorn/string-compare.hpp unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp \
  unicorn/character.hpp unicorn/property-values.hpp \
  unicorn/string-algorithm.hpp unicorn/string-forward.hpp unicorn/utf.hpp \
  unicorn/string-property.hpp unicorn/string-size.hpp unicorn/segment.hpp \
  unicorn/string-case.hpp $(LIBROOT)/prion-lib/prion/unit-test.hpp
...
build/$(TARGET)/string-property-test.o: unicorn/string-property-test.cpp \
  unicorn/string-property.hpp unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp \
  unicorn/character.hpp unicorn/property-values.hpp \
  unicorn/string-forward.hpp unicorn/utf.hpp unicorn/string-size.hpp \
