...
build/$(TARGET)/environment.o: unicorn/environment.cpp unicorn/environment.hpp \
  ...
  unicorn/string-algorithm.hpp unicorn/string-case.hpp \
  unicorn/string-compare.hpp unicorn/string-conversion.hpp \
  unicorn/string-forward.hpp unicorn/string-property.hpp \
  unicorn/string-size.hpp unicorn/segment.hpp unicorn/string-escape.hpp \
...
build/$(TARGET)/file-test.o: unicorn/file-test.cpp unicorn/core.hpp \
  ...
  unicorn/string-algorithm.hpp unicorn/utf.hpp unicorn/string-case.hpp \
  unicorn/string-compare.hpp unicorn/string-conversion.hpp \
  unicorn/string-forward.hpp unicorn/string-property.hpp \
  unicorn/string-size.hpp unicorn/segment.hpp unicorn/string-escape.hpp \
...
build/$(TARGET)/lexer-test.o: unicorn/lexer-test.cpp unicorn/core.hpp \
  ...
  unicorn/string-case.hpp unicorn/string-compare.hpp \
  unicorn/string-conversion.hpp unicorn/string-forward.hpp \
  unicorn/string-property.hpp unicorn/string-size.hpp \
  unicorn/segment.hpp unicorn/string-escape.hpp unicorn/string-manip.hpp \
  $(LIBROOT)/prion-lib/prion/unit-test.hpp
...
build/$(TARGET)/mbcs.o: unicorn/mbcs.cpp unicorn/mbcs.hpp unicorn/core.hpp \
  ...
  unicorn/regex.hpp unicorn/string.hpp unicorn/string-algorithm.hpp \
  unicorn/string-case.hpp unicorn/string-compare.hpp \
  unicorn/string-conversion.hpp unicorn/string-forward.hpp \
  unicorn/string-property.hpp unicorn/string-size.hpp \
  unicorn/segment.hpp unicorn/string-escape.hpp unicorn/string-manip.hpp
...
build/$(TARGET)/options.o: unicorn/options.cpp unicorn/options.hpp unicorn/core.hpp \
  ...
  unicorn/string-property.hpp unicorn/string-size.hpp \
  unicorn/segment.hpp unicorn/string-escape.hpp unicorn/string-manip.hpp \
  unicorn/format.hpp unicorn/mbcs.hpp
...
build/$(TARGET)/segment-test.o: unicorn/segment-test.cpp unicorn/core.hpp \
  ...
  unicorn/string-compare.hpp unicorn/string-conversion.hpp \
  unicorn/string-forward.hpp unicorn/string-property.hpp \
  unicorn/string-size.hpp unicorn/string-escape.hpp \
  unicorn/string-manip.hpp unicorn/ucd-tables.hpp \
  $(LIBROOT)/prion-lib/prion/unit-test.hpp
...
build/$(TARGET)/string-algorithm-test.o: unicorn/string-algorithm-test.cpp \
  unicorn/string-algorithm.hpp unicorn/core.hpp \
  $(LIBROOT)/prion-lib/prion/core.hpp unicorn/utf.hpp unicorn/character.hpp \
  unicorn/property-values.hpp $(LIBROOT)/prion-lib/prion/unit-test.hpp
build/$(TARGET)/string-algorithm.o: unicorn/string-algorithm.cpp \
  unicorn/string-algorithm.hpp unicorn/core.hpp \
  $(LIBROOT)/prion-lib/prion/core.hpp unicorn/utf.hpp unicorn/character.hpp \
  unicorn/property-values.hpp unicorn/string-forward.hpp \
  unicorn/string-property.hpp unicorn/string-size.hpp \
  unicorn/segment.hpp
build/$(TARGET)/string-case-test.o: unicorn/string-case-test.cpp unicorn/string-case.hpp \
  unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp unicorn/character.hpp \
  unicorn/property-values.hpp unicorn/utf.hpp \
  $(LIBROOT)/prion-lib/prion/unit-test.hpp
build/$(TARGET)/string-case.o: unicorn/string-case.cpp unicorn/string-case.hpp \
  unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp unicorn/character.hpp \
...
build/$(TARGET)/string-escape-test.o: unicorn/string-escape-test.cpp \
  unicorn/string-escape.hpp unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp \
  unicorn/string-size.hpp unicorn/character.hpp \
  unicorn/property-values.hpp unicorn/segment.hpp unicorn/utf.hpp \
  unicorn/string-forward.hpp $(LIBROOT)/prion-lib/prion/unit-test.hpp
build/$(TARGET)/string-escape.o: unicorn/string-escape.cpp unicorn/string-escape.hpp \
  unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp unicorn/string-size.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/segment.hpp \
  unicorn/utf.hpp unicorn/string-forward.hpp unicorn/string-property.hpp
build/$(TARGET)/string-forward.o: unicorn/string-forward.cpp unicorn/string-forward.hpp \
  unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp unicorn/character.hpp \
  unicorn/property-values.hpp unicorn/utf.hpp
build/$(TARGET)/string-manip-a-e-test.o: unicorn/string-manip-a-e-test.cpp \
  unicorn/string-manip.hpp unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp \
  unicorn/string-forward.hpp unicorn/character.hpp \
  unicorn/property-values.hpp unicorn/utf.hpp unicorn/string-size.hpp \
  unicorn/segment.hpp $(LIBROOT)/prion-lib/prion/unit-test.hpp
...
build/$(TARGET)/string-manip-s-z-test.o: unicorn/string-manip-s-z-test.cpp \
  ...
  unicorn/property-values.hpp unicorn/utf.hpp unicorn/string-size.hpp \
  unicorn/segment.hpp $(LIBROOT)/prion-lib/prion/unit-test.hpp
build/$(TARGET)/string-manip.o: unicorn/string-manip.cpp unicorn/string-manip.hpp \
  unicorn/core.hpp $(LIBROOT)/prion-lib/prion/core.hpp \
  unicorn/string-forward.hpp unicorn/character.hpp \
  unicorn/property-values.hpp unicorn/utf.hpp unicorn/string-size.hpp \
  unicorn/segment.hpp unicorn/string-algorithm.hpp \
