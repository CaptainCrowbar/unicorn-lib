build/$(TARGET)/character-test.o: unicorn/character-test.cpp unicorn/character.hpp \
  unicorn/core.hpp unicorn/property-values.hpp unicorn/ucd-tables.hpp \
  unicorn/unit-test.hpp
...
build/$(TARGET)/core-test.o: unicorn/core-test.cpp unicorn/core.hpp unicorn/unit-test.hpp
build/$(TARGET)/core.o: unicorn/core.cpp unicorn/core.hpp
build/$(TARGET)/file-test.o: unicorn/file-test.cpp unicorn/core.hpp unicorn/file.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/string.hpp \
  unicorn/segment.hpp unicorn/utf.hpp unicorn/unit-test.hpp
build/$(TARGET)/file.o: unicorn/file.cpp unicorn/file.hpp unicorn/character.hpp \
  unicorn/core.hpp unicorn/property-values.hpp unicorn/string.hpp \
...
build/$(TARGET)/format-test.o: unicorn/format-test.cpp unicorn/format.hpp \
  unicorn/character.hpp unicorn/core.hpp unicorn/property-values.hpp \
  unicorn/regex.hpp unicorn/string.hpp unicorn/segment.hpp \
  unicorn/utf.hpp unicorn/unit-test.hpp
build/$(TARGET)/format.o: unicorn/format.cpp unicorn/format.hpp unicorn/character.hpp \
  unicorn/core.hpp unicorn/property-values.hpp unicorn/regex.hpp \
  unicorn/string.hpp unicorn/segment.hpp unicorn/utf.hpp
build/$(TARGET)/io-test.o: unicorn/io-test.cpp unicorn/core.hpp unicorn/io.hpp \
...
build/$(TARGET)/io.o: unicorn/io.cpp unicorn/io.hpp unicorn/character.hpp \
  unicorn/core.hpp unicorn/property-values.hpp unicorn/file.hpp \
  unicorn/string.hpp unicorn/segment.hpp unicorn/utf.hpp \
  unicorn/format.hpp unicorn/regex.hpp unicorn/mbcs.hpp
build/$(TARGET)/lexer-test.o: unicorn/lexer-test.cpp unicorn/core.hpp unicorn/lexer.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/format.hpp \
  unicorn/regex.hpp unicorn/string.hpp unicorn/segment.hpp \
  unicorn/utf.hpp unicorn/unit-test.hpp
build/$(TARGET)/mbcs-test.o: unicorn/mbcs-test.cpp unicorn/core.hpp unicorn/mbcs.hpp \
...
build/$(TARGET)/mbcs.o: unicorn/mbcs.cpp unicorn/mbcs.hpp unicorn/character.hpp \
  unicorn/core.hpp unicorn/property-values.hpp unicorn/utf.hpp \
...
build/$(TARGET)/normal-test.o: unicorn/normal-test.cpp unicorn/core.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/normal.hpp \
  unicorn/utf.hpp unicorn/string.hpp unicorn/segment.hpp \
  unicorn/ucd-tables.hpp unicorn/unit-test.hpp
...
build/$(TARGET)/options.o: unicorn/options.cpp unicorn/options.hpp unicorn/character.hpp \
  unicorn/core.hpp unicorn/property-values.hpp unicorn/format.hpp \
  unicorn/regex.hpp unicorn/string.hpp unicorn/segment.hpp \
  unicorn/utf.hpp unicorn/mbcs.hpp
build/$(TARGET)/regex-test.o: unicorn/regex-test.cpp unicorn/core.hpp unicorn/regex.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/string.hpp \
  unicorn/segment.hpp unicorn/utf.hpp unicorn/unit-test.hpp
...
build/$(TARGET)/segment-test.o: unicorn/segment-test.cpp unicorn/segment.hpp \
  unicorn/character.hpp unicorn/core.hpp unicorn/property-values.hpp \
  unicorn/utf.hpp unicorn/string.hpp unicorn/ucd-tables.hpp \
  unicorn/unit-test.hpp
...
build/$(TARGET)/string-algorithm-test.o: unicorn/string-algorithm-test.cpp \
  ...
  unicorn/string.hpp unicorn/segment.hpp unicorn/utf.hpp \
  unicorn/unit-test.hpp
build/$(TARGET)/string-case-test.o: unicorn/string-case-test.cpp unicorn/core.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/string.hpp \
  unicorn/segment.hpp unicorn/utf.hpp unicorn/unit-test.hpp
...
build/$(TARGET)/string-manip-s-z-test.o: unicorn/string-manip-s-z-test.cpp \
  ...
  unicorn/string.hpp unicorn/segment.hpp unicorn/utf.hpp \
  unicorn/unit-test.hpp
build/$(TARGET)/string-property-test.o: unicorn/string-property-test.cpp unicorn/core.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/string.hpp \
  unicorn/segment.hpp unicorn/utf.hpp unicorn/unit-test.hpp
build/$(TARGET)/string-size-test.o: unicorn/string-size-test.cpp unicorn/core.hpp \
  unicorn/character.hpp unicorn/property-values.hpp unicorn/string.hpp \
  unicorn/segment.hpp unicorn/utf.hpp unicorn/unit-test.hpp
...
build/$(TARGET)/ucd-character-names.o: unicorn/ucd-character-names.cpp \
  unicorn/ucd-tables.hpp unicorn/character.hpp unicorn/core.hpp \
...
build/$(TARGET)/ucd-segmentation-test.o: unicorn/ucd-segmentation-test.cpp \
  unicorn/ucd-tables.hpp unicorn/character.hpp unicorn/core.hpp \
  unicorn/property-values.hpp
build/$(TARGET)/utf-test.o: unicorn/utf-test.cpp unicorn/core.hpp unicorn/character.hpp \
  unicorn/property-values.hpp unicorn/unit-test.hpp unicorn/utf.hpp
build/$(TARGET)/utf.o: unicorn/utf.cpp unicorn/utf.hpp unicorn/character.hpp \
  unicorn/core.hpp unicorn/property-values.hpp
